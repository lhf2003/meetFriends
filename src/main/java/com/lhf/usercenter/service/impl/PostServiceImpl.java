...
import com.lhf.usercenter.common.utils.SqlUtils;
...
import com.lhf.usercenter.mapper.PostFavourMapper;
import com.lhf.usercenter.mapper.PostMapper;
import com.lhf.usercenter.mapper.PostThumbMapper;
import com.lhf.usercenter.model.domain.Post;
import com.lhf.usercenter.model.domain.PostFavour;
import com.lhf.usercenter.model.domain.PostThumb;
...
public class PostServiceImpl extends ServiceImpl<PostMapper, Post> implements PostService {
    ...
    public void validPost(Post post, boolean add) {
        ...
        // 创建时，参数不能为空
        if (add) {
            ThrowUtils.throwIf(StringUtils.isAnyBlank(title, content, tags), ErrorCode.PARAM_ERROR);
        }
        // 有参数则校验
