...
import com.lhf.usercenter.annotation.AuthCheck;
...
import com.lhf.usercenter.model.request.DeleteRequest;
import com.lhf.usercenter.model.request.post.PostAddRequest;
import com.lhf.usercenter.model.request.post.PostEditRequest;
import com.lhf.usercenter.model.request.post.PostQueryRequest;
import com.lhf.usercenter.model.request.post.PostUpdateRequest;
...
public class PostController {
    ...
    public BaseResponse<Long> addPost(@RequestBody PostAddRequest postAddRequest, HttpServletRequest request) {
        ...
        ThrowUtils.throwIf(!result, ErrorCode.ERROR);
    ...
    public BaseResponse<Page<Post>> listPostByPage(@RequestBody PostQueryRequest postQueryRequest) {
        ...
        if (postPage == null || postPage.getRecords().isEmpty()) {
            throw new BusinessException(ErrorCode.NOT_FOUND_ERROR);
        }
